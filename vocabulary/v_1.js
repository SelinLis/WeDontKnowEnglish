      ...
      <html>
          ...
          <body>
              <div class="results-container">
                  ...
                  <p class="feedback ${feedback6.includes("That\'s right!") ? 'correct' : feedback1.includes('Sorry') ? 'incorrect' : 'no-answer'}">6: ${feedback6}</p>
                  <p class="feedback ${feedback7.includes("That\'s right!") ? 'correct' : feedback2.includes('Sorry') ? 'incorrect' : 'no-answer'}">7: ${feedback7}</p>
                  <p class="feedback ${feedback8.includes("That\'s right!") ? 'correct' : feedback3.includes('Sorry') ? 'incorrect' : 'no-answer'}">8: ${feedback8}</p>
                  <p class="feedback ${feedback9.includes("That\'s right!") ? 'correct' : feedback4.includes('Sorry') ? 'incorrect' : 'no-answer'}">9: ${feedback9}</p>
                  <p class="feedback ${feedback10.includes("That\'s right!") ? 'correct' : feedback5.includes('Sorry') ? 'incorrect' : 'no-answer'}">10: ${feedback10}</p>
